    ...
    <div class="container">
        ...
        <form action="{{ route('admin.sellables.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-control d-flex flex-column mt-4 mb-2">
                ...
                <input class="mb-3" type="text" name="name" id="name" maxlength="255" required>

                {{-- Descrizione Prodotto --}}
                <label class="mb-2 fs-5" for="description">Descrizione del Prodotto</label>
                <textarea class="mb-3" type="text" name="description" id="description" rows="2"></textarea>

                {{-- Prezzo Prodotto --}}
                <label class="mb-2 fs-5" for="price">Prezzo del Prodotto</label>
                <input class="mb-3" type="number" name="price" id="price" step="0.01" min="0" max="9999.99" required>
