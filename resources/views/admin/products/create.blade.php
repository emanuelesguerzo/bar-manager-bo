...
@section("content")
    <div class="container mt-3">
        ...
        {{-- Form --}}
        <form class="form-box rounded p-3 mb-5" method="POST" action="{{ route("admin.products.store") }}"
            ...
            <div class="mb-4">
                ...
                <div class="form-text text-muted">Invia un alert nella dashboard quando le unità in magazzino scendono a questo valore.</div>
            </div>
